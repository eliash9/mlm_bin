<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_kategoriberita',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Posisi</th>                         <td><input type='text' class='form-control' name='c' value='$rows[sidebar]'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
