<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_manajemenmodul',$attributes); 
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Link</th>                       <td><input type='text' class='form-control' name='b' value='$rows[link]' required></td></tr>
