            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Kirim Kode Perwakilan</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
        <?php
          $rows = $this->db->query("SELECT a.*, c.nama_perwakilan as nama_lengkap, c.telp_hp as no_hp, c.email, c.alamat_lengkap FROM rb_order_kode_konsumen a 
                                      JOIN rb_perwakilan c ON a.id_konsumen=c.id_perwakilan
            ...
            echo "<div class='col-md-12'>
                ...
                echo form_open_multipart('administrator/kirim_orderkodeperwakilan',$attributes); 
          ...
          echo "<table class='table table-condensed table-bordered'>
                ...
                <table class='table table-hover table-condensed'>
                  ...
                  echo "<tr>
                        ...
                        <td>$status</td>
                        <td><center>
                            <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_orderkodeperwakilan/$row[id_order_kode_kirim]/".$this->uri->segment(3)."' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                        </center></td>
                      </tr>";
                    $no++;
                  }
